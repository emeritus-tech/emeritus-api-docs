...
/**
 * Select option to change the school theme stylesheet
 */
$("select.selectpicker").on("change", function () {
  var theme = document.getElementById("school-theme");
  theme.setAttribute("href", "institution_assets/css/" + this.value);
});
